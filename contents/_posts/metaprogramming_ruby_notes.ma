---
title: metaprogramming ruby notes
tags: [notes, ruby]
date: 2013-05-01
---

h2#object Object model

h3#object-class class and objects
...
h3#object-module class and module
...
h3#object-class-definition class definition
...
h3#monkey-patch Monkey See, Monkey Patch
...
h3#around-aliases Around Aliases < Monkey Patch
...
h3#class-methods class methods:
...
h3#current-class The Current Class:
...
h3#methods-lookup method lookup:
...
h3#module-lookup module lookup:
...
h3#private-method private method
...
h3#dynamic-call Calling Methods Dynamically:
...
h3#dynamic-proxies Dynamic Proxies:
...
h2#scope Scope:
h3#bindings bindings and scope
...
- Instead of def, you can use `Module#define\_method( )`

h3#shared-scope shared scope:
...
h3#callable Callable Objects:
h5#deferred Deferred Evaluation:
...
h5#proc-lambda proc and lambda:
...
h2#wrap-up Objects and Classes Wrap-Up

h3#object-wrapup What’s an object? 
...
h3#class-wrapup What’s a class? 
...
h2#rules Seven rules of the Ruby object model:
